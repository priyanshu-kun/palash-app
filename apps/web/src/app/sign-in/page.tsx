  ...
  return (
    <ErrorBoundary>
      <main className="min-h-screen w-full flex overflow-hidden">
        ...
        <div ref={leftSectionRef} className="flex-1 relative flex items-center justify-center">
        {/* Video Background */}
        <video
          ref={videoRef}
          autoPlay
        ...
        {/* Animated Content */}
        <div className="relative z-10 text-white text-center px-8 max-w-lg">
          <h1 
            ref={titleRef}
          ...
          <p 
            ref={subtitleRef}
            className="text-xl md:text-2xl mb-8 text-emerald-100 font-light leading-relaxed"
          >
            Journey to Wellness
          </p>
          ...
          <div className="space-y-4">
            <div 
              ...
              className="flex items-center justify-center space-x-3 text-emerald-100"
            >
              <div className="w-2 h-2 bg-emerald-400 rounded-full"></div>
              <span className="text-lg">Ayurveda & Wellness</span>
            </div>
            ...
            >
              <div className="w-2 h-2 bg-emerald-400 rounded-full"></div>
              <span className="text-lg">Luxury Spa & Panchkarma</span>
            </div>
            ...
            >
              <div className="w-2 h-2 bg-emerald-400 rounded-full"></div>
              <span className="text-lg">Family Wellness Programs</span>
            </div>
            ...
            >
              <div className="w-2 h-2 bg-emerald-400 rounded-full"></div>
              <span className="text-lg">Holistic Healing Experience</span>
            </div>
          </div>
        </div>
        
        {/* Decorative Elements */}
        <div className="absolute top-10 left-10 w-20 h-20 border border-emerald-400/30 rounded-full animate-pulse"></div>
        <div className="absolute bottom-20 right-10 w-16 h-16 border border-emerald-400/30 rounded-full animate-pulse delay-1000"></div>
        <div className="absolute top-1/3 right-20 w-12 h-12 border border-emerald-400/30 rounded-full animate-pulse delay-500"></div>
      </div>

      {/* Right Section - Sign In Form */}
      <div 
        ref={formRef}
        className="flex-1 bg-[#f0f4f1] flex items-center justify-center p-4 md:p-6 relative"
      >
