          ...
          <div className="relative z-10 text-white text-center px-4 sm:px-6 lg:px-8 max-w-sm sm:max-w-md lg:max-w-lg">
            ...
            <div className="space-y-2 sm:space-y-3 lg:space-y-4">
              ...
              >
                ...
                <span className="text-sm sm:text-base lg:text-lg">Ayurveda & Wellness</span>
              </div>
              ...
              >
                <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-emerald-400 rounded-full"></div>
                <span className="text-sm sm:text-base lg:text-lg">Luxury Spa & Panchkarma</span>
              </div>
              ...
              >
                <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-emerald-400 rounded-full"></div>
                <span className="text-sm sm:text-base lg:text-lg">Family Wellness Programs</span>
              </div>
              ...
              >
                <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-emerald-400 rounded-full"></div>
                <span className="text-sm sm:text-base lg:text-lg">Holistic Healing Experience</span>
              </div>
            </div>
          </div>
