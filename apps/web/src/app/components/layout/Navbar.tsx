...
const Navbar = () => {
    ...
    return (
        <nav className={`fixed top-10 left-1/2  rounded-lg w-full max-w-[90%] z-50 transition-all -translate-x-1/2 duration-300 ${isScrolled ? 'bg-white/80 backdrop-blur-md shadow-sm' : 'bg-white'
            }`}>
